        ...
        <section id="Contact" className="text-gray-400 bg-gray-900 body-font relative">
            <div className="container px-5 py-24 mx-auto">
                <div className="flex flex-col text-center w-full mb-12">
                    ...
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Have a Query? Feel free to reach out to us by filling in the form below</p>
                </div>
                <div className="lg:w-1/2 md:w-2/3 mx-auto">
                    <div className="flex flex-wrap -m-2">
                        ...
                        <div className="p-2 w-full pt-8 mt-8 border-t border-gray-800 text-center">
                            <a className="text-green-400">docstreamsupport@gmail.com</a>
                            <p className="leading-normal my-5">VIT Vellore, Katpadi
                                <br />Vellore, TN, India
                            </p>
